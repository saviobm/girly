...
export class ApiService {
  private REG_API="http://localhost:9000/login/user/signup";
  private LOGU_API="http://localhost:9000/login/user/verify";
  private LOGA_API="http://localhost:9000/login/admin/verify";
  private PRDLST_API="http://localhost:9000/user/getProducts";
  private ADD_CART_API="http://localhost:9000/user/addToCart?productId=";
  private VW_CART_API="http://localhost:9000/user/viewCart";
  private UP_CART_API="http://localhost:9000/user/updateCart";
  private DEL_CART_API="http://localhost:9000/user/delCart";
  private PLC_ORD_API="http://localhost:9000/user/placeOrder";
  private ADR_API="http://localhost:9000/user/addAddress";
  private GT_ADR_API="http://localhost:9000/user/getAddress";
  private ADD_PRD_API="http://localhost:9000/admin/addProduct";
  private DEL_PRD_API="http://localhost:9000/admin/delProduct";
  private UPD_PRD_API="http://localhost:9000/admin/updateProducts";
  private ORD_API="http://localhost:9000/admin/viewOrders";
  private UPD_ORD_API="http://localhost:9000/admin/updateOrder";
  ...
  retornoSucesso(response: Response): void {
    const usuario: User = response.json() as User;
    console.log(usuario);
  }
